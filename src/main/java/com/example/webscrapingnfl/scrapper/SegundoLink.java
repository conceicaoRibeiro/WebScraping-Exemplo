...
public class SegundoLink {
	...
	public static void main(String[] args) throws IOException {
		...
		String uri = "https://www.infomoney.com.br/mercados/cade-aprova-acordo-entre-caixa-seguridade-e-"
				+ "mds-para-negocios-de-co-corretagem/";
		Document doc = Jsoup.connect(uri).get();

		Elements link = document.getElementById("post-1664306").select("a[href]");
